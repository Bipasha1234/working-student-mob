...
class _RegisterViewState extends State<RegisterView> {
  ...
  final _fnameController = TextEditingController(text: 'bipasha');
  final _lnameController = TextEditingController(text: 'lamsal');
  final _phoneController = TextEditingController(text: '9841459951');
...
//                                 onPressed: () {
//                                   Navigator.pop(context);
//                                   _pickImageFromCamera(); // Camera selection
//                                 },
//                                 icon: const Icon(Icons.camera),
//                                 label: const Text('Camera'),
//                               ),
...
//                                 onPressed: () {
//                                   Navigator.pop(context);
//                                   _pickImageFromGallery(); // Gallery selection
//                                 },
//                                 icon: const Icon(Icons.image),
//                                 label: const Text('Gallery'),
//                               ),
